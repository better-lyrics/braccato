...
// demo/: the package emitted to packages/core/dist/package, and the extension's icons. A host has no
// repository around the page, so both are copied in beside it and the references that pointed
// outward are moved to match. That table is the entire difference between the two ways of serving
// this page: there is one copy of the HTML, one of the script and one of the stylesheet, and
// `pnpm demo` keeps reading them where they are written.
//
...
const packageDir = join(root, "packages", "core", "dist", "package");
...
const REWRITES: [string, string][] = [
  ["../packages/core/dist/package", "./package"],
  ["../images/icons", "./icons"],
];
